...
router.post('/item', async (req, res) => {
  ...
  try {
    ...
    for (const item of items) {
      ...
      const NAV_URL = `https://my430301-api.s4hana.cloud.sap/sap/opu/odata/sap/YY1_GATEINWARD_OUTWARDDETA_CDS/YY1_GATEINWARD_OUTWARDDETA(guid'${item.SAP_PARENT_UUID}')/to_GateEntryItems`;
