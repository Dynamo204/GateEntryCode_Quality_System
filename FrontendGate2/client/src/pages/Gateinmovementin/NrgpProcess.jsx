...
export default function NrgpProcess() {
  ...
  // Helper to generate the PDF element and file name
  const generatePdfElementAndName = async () => {
    const now = new Date();
    ...
    const headerRows = [
      ["Gate Entry No:", createdGateEntryNum || "-", "Date:", printDate],
      ["Plant:", getField("plant", "Plant"), "Time:", printTime],
      ["Vendor:", getField("vendor", "Vendor"), "Vehicle No:", getField("vehicleNumber", "VehicleNumber")],
      ["Vendor Name:", getField("vendorName", "VendorName"), "Mode of Transport:", modeValue],
      ["Department:", getField("department", "Department"), "Requisitioner:", getField("requisitioner", "Requisitioner")],
      ["Transporter Name:", getField("transporterName", "TransporterName"), "Driver Name:", getField("driverName", "DriverName")],
  ...
  const handlePrint = async () => {
    ...
    const { element, fileName } = await generatePdfElementAndName();
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      setPrintStatus("Failed to download PDF.");
      ...
      {showSuccessModal && (
        <div className="modal-overlay">
          <div className="success-modal">
            ...
            <button
              className="submit-btn"
              style={{ marginTop: "10px", marginBottom: "6px", marginLeft: "8px", background: "#2563eb" }}
      ...
      {showSuccessModal && (
        <div className="sc-success-overlay">
          <div className="sc-success-modal">
            ...
            <h2 className="sc-modal-title">NRGP Gate Entry Created Successfully!</h2>
